...
echo ----- 6-3 -----
kubectl exec -it $(kubectl get pod -l wsi=skills -n skills --no-headers -o custom-columns=":metadata.name" | grep wsi-customer | head -n 1) -n skills -- curl -X GET "http://naver.com" --max-time 10
